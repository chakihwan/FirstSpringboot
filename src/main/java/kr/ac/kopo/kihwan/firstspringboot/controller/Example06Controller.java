package kr.ac.kopo.kihwan.firstspringboot.controller;
...
public class Example06Controller {
    ...
    public String requestMethod2(ModelMap modelMap) {
        modelMap.addAttribute("messege1", "ModelMap 클래스는 Model 인터페이스를 상속 받아서 구현되었다.");
        modelMap.addAttribute("messege2", "ModelMap 클래스는 Model 인터페이스의 기능과 동일 하거나 더 확장된 기능(method)을 사용할 수 있다.");
...
//        modelView.setViewName();
        ...
        modelView.addObject("msg3", "ModelAndView 클래스는 값이나 객체 참조값을 전달할 때 Model 또는 ModelMap 사용하는 메소드가 다르다. ex)addObject");
